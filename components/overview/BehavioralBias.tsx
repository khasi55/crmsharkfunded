...
export default function BehavioralBias({ totalTrades = 585, buyCount = 330, sellCount = 255 }: BehavioralBiasProps) {
    const buyPercentage = Math.round((buyCount / totalTrades) * 100) || 0;
