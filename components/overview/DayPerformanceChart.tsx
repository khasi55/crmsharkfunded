...
const days = [
    { label: "Mon", value: -1100, color: "#ef4444" },
    { label: "Tue", value: -1200, color: "#ef4444" },
    { label: "Wed", value: -1900, color: "#ef4444" },
    { label: "Thu", value: -765, color: "#ef4444" },
    { label: "Fri", value: 2300, color: "#22c55e" },
];

export default function DayPerformanceChart() {
    const maxValue = Math.max(...days.map(d => Math.abs(d.value)));
    const bestDay = days.reduce((a, b) => a.value > b.value ? a : b);

    return (
        <div className="flex flex-col h-full justify-between pb-2 bg-[#121826]/30 rounded-2xl">
