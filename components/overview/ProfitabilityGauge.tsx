...
export default function ProfitabilityGauge({
    ...
    const displayTrades = tradesTaken || 585;
    const displayWonPct = wonPct || 43.6;
    const displayLostPct = lostPct || 56.40;
    const displayWonCount = wonCount || 255;
    const displayLostCount = lostCount || 330;
    const displayWinRate = winRate || 43.6;
    const avgHoldingPeriod = "34m"; // Mock
