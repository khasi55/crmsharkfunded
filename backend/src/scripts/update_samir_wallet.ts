...
async function updateWallet() {
    ...
    const walletAddress = 'TQs4scLth49Zm1HXK9sZC18GPeJfhGNFpP';
    ...
    try {
        ...
        // 3. Update pending payout requests
        ...
        console.log('Final Wallet State:', JSON.stringify(finalWallet, null, 2));
