        ...
        if (finalOrder.is_account_created && finalOrder.login) {
            ...
            const { data: challenge, error: challengeError } = await supabase
                ...
                .insert({
                    ...
                    server: (mt5Data as any).server || 'Xylo Markets Ltd  LIMITED',
            ...
            if (email) {
                ...
                await EmailService.sendAccountCredentials(
                    ...
                    (mt5Data as any).server || 'Xylo Markets Ltd  LIMITED',
                ...
                if (existingBOGO) {
                    ...
                    const { data: freeChallenge } = await supabase
                        ...
                        .insert({
                            ...
                            server: mt5DataFree.server || 'Xylo Markets Ltd  LIMITED',
                            platform: order.platform,
                            leverage: leverage,
                            group: mt5Group,
                    ...
                    if (freeChallenge) {
                        ...
                        if (email) {
                            await EmailService.sendAccountCredentials(
                                ...
                                mt5DataFree.server || 'Xylo Markets Ltd  LIMITED',
